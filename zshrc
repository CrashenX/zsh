...
POWERLEVEL9K_LEFT_PROMPT_ELEMENTS=(os_icon context vi_mode battery dir vcs)
POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(status time dir_writable custom_wifi_signal load background_jobs)
